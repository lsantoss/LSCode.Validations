...
namespace LSCode.Validador.ValidacoesNotificacoes
{
    public class ContratoValidacao : Notificadora
    {
        ...
        {
            if () { return new ContratoValidacao(); } else { ContratoValidacao contratoValidacao = new ContratoValidacao(); contratoValidacao.AddNotificacao(propriedade, mensagem); return contratoValidacao; }
        }
