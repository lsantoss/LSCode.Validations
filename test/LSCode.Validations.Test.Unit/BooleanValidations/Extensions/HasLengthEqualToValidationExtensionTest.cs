...
using static LSCode.Validations.Test.Tools.Mocks.BooleanValidations.Extensions.HasLengthEqualToValidationExtensionMockData;

namespace LSCode.Validations.Test.Unit.BooleanValidations.Extensions
{
    [TestFixture]
    internal class HasLengthEqualToValidationExtensionTest
    {
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_sbyte_ShouldReturnTrue_Data))]
        ...
        [TestCase(null, 0)]
        [TestCase(null, 1)]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_sbyte_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_byte_ShouldReturnTrue_Data))]
        ...
        [TestCase(null, 0)]
        [TestCase(null, 1)]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_byte_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_short_ShouldReturnTrue_Data))]
        ...
        [TestCase(null, 0)]
        [TestCase(null, 1)]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_short_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_ushort_ShouldReturnTrue_Data))]
        ...
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_ushort_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_int_ShouldReturnTrue_Data))]
        ...
        [TestCase(null, 0)]
        [TestCase(null, 1)]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_int_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_uint_ShouldReturnTrue_Data))]
        ...
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_uint_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_long_ShouldReturnTrue_Data))]
        ...
        [TestCase(null, 0)]
        [TestCase(null, 1)]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_long_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_ulong_ShouldReturnTrue_Data))]
        ...
        [TestCaseSource(typeof(HasLengthEqualToValidationExtensionMockData), nameof(HasLengthEqualTo_IEnumerable_ulong_ShouldReturnFalse_Data))]
