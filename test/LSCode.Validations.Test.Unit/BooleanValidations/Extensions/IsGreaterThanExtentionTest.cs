...
namespace LSCode.Validations.Test.Unit.BooleanValidations.Extensions
{
    internal class IsGreaterThanExtentionTest
    {
        ...
        public void IsGreaterThan_datetime_datetime_True_Success(int year, int month, int day, int comparedYear, int comparedMonth, int comparedDay)
        {
            //Arrange
        ...
        public void IsGreaterThan_datetime_datetime_False_Success(int year, int month, int day, int comparedYear, int comparedMonth, int comparedDay)
        {
            //Arrange
            var value = new DateTime(year, month, day);
            var comparedValue = new DateTime(comparedYear, comparedMonth, comparedDay);
        ...
        [TestCase(20, 10)]
        [TestCase(200, 100)]
        public void IsGreaterThan_timespan_timespan_True_Success(long trikcs, long comparedTricks)
        {
            //Arrange
        ...
        [TestCase(100, 100)]
        [TestCase(100, 200)]
        public void IsGreaterThan_timespan_timespan_False_Success(long trikcs, long comparedTricks)
        {
            //Arrange
            var value = new TimeSpan(trikcs);
            var comparedValue = new TimeSpan(comparedTricks);
