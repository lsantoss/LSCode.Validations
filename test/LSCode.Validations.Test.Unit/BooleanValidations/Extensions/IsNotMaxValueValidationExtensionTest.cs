...
using System;
using static LSCode.Validations.Test.Tools.Mocks.BooleanValidations.Extensions.IsNotMaxValueValidationExtensionMockData;

namespace LSCode.Validations.Test.Unit.BooleanValidations.Extensions
{
    [TestFixture]
    internal class IsNotMaxValueValidationExtensionTest
    {
        [Test]
        [TestCase(-1)]
        [TestCase(0)]
        ...
        [Test]
        [TestCaseSource(typeof(IsNotMaxValueValidationExtensionMockData), nameof(IsNotMaxValue_decimal_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(IsNotMaxValueValidationExtensionMockData), nameof(IsNotMaxValue_char_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(IsNotMaxValueValidationExtensionMockData), nameof(IsNotMaxValue_DateTime_ShouldReturnTrue_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(IsNotMaxValueValidationExtensionMockData), nameof(IsNotMaxValue_DateTime_ShouldReturnFalse_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(IsNotMaxValueValidationExtensionMockData), nameof(IsNotMaxValue_TimeSpan_ShouldReturnTrue_Data))]
        ...
        [Test]
        [TestCaseSource(typeof(IsNotMaxValueValidationExtensionMockData), nameof(IsNotMaxValue_TimeSpan_ShouldReturnFalse_Data))]
