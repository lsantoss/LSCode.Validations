...
namespace LSCode.Validations.Test.Unit.BooleanValidations.Extensions
{
    ...
    internal class AreEqualsExtensionTest
    {
        ...
        [Test]
        public void AreEquals_char_char_Success()
        {
            //Arrange
            char value = 'a';
            char valueEqual = 'a';
        ...
        public void AreEquals_datetime_datetime_True_Success(int year, int month, int day, int comparedYear, int comparedMonth, int comparedDay)
        {
            //Arrange
        ...
        public void AreEquals_datetime_datetime_False_Success(int year, int month, int day, int comparedYear, int comparedMonth, int comparedDay)
        {
            //Arrange
            var value = new DateTime(year, month, day);
            var comparedValue = new DateTime(comparedYear, comparedMonth, comparedDay);
        ...
        [TestCase(10, 10)]
        [TestCase(100, 100)]
        public void AreEquals_timespan_timespan_True_Success(long trikcs, long comparedTricks)
        {
            //Arrange
        ...
        [TestCase(10, 20)]
        [TestCase(100, 200)]
        public void AreEquals_timespan_timespan_False_Success(long trikcs, long comparedTricks)
        {
            //Arrange
            var value = new TimeSpan(trikcs);
            var comparedValue = new TimeSpan(comparedTricks);
