...
{
    [TestFixture]
    internal class IsNotPaymentMethodValidationExtensionTest
    {
        [Test]
        ...
        [TestCase(" ")]
        [TestCase(null)]
        public void IsNotCreditCard_ShouldReturnTrue(string value)
        {
            //Act
            var result = value.IsNotCreditCard();
        ...
        public void IsNotCreditCard_ShouldReturnFalse(string value)
        {
            //Act
            var result = value.IsNotCreditCard();
