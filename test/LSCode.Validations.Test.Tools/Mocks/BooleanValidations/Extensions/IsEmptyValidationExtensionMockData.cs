...
{
    internal static class IsEmptyValidationExtensionMockData
    {
        public static readonly object[] IsEmpty_Guid_ShouldReturnTrue_Data =
        {
            new object[] { Guid.Empty },
        };

        public static readonly object[] IsEmpty_Guid_ShouldReturnFalse_Data =
        {
