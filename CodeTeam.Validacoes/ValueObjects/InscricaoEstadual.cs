...
{
    public class InscricaoEstadual : Notificadora
    {
        public string Uf { get; private set; }
        public string Inscricao { get; private set; }


        //TODO: Fazer validação e retorno

        //public InscricaoEstadual(string uf, string inscricao)
        //{
        //    this.Uf = uf;
        //    this.Inscricao = inscricao;
        //    AddNotifications(new ValidationContract().IsTrue(Validar(Uf, Inscricao), "Inscrição Estadual", "Inscrição Estadual Inválida"));
        //}
        ...
        public bool Validar(string pUF, string pInscr)
        {
            bool retorno = false;
            string strBase;
            string strBase2;
