namespace LSCode.Validations.BooleanValidations.Extensions
{
    ...
    public static class IsNotDocumentExtension
    {
        ...
        public static bool IsNotBrazilianPassport(this string value) => !IsDocumentExtension.IsBrazilianPassport(value);
        ...
        public static bool IsNotCNPJ(this string value) => !IsDocumentExtension.IsCNPJ(value);
        ...
        public static bool IsNotCPF(this string value) => !IsDocumentExtension.IsCPF(value);
    }
}