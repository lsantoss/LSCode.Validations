...
namespace LSCode.Validations.BooleanValidations.Extensions
{
    ...
    public static class HasLengthEqualToExtension
    {
        ...
        /// <summary>Validates if the length is the same as desired.</summary>
        /// <param name="value">Value to be used for comparison.</param>
        /// <param name="lenght">Desired length.</param>
        /// <returns>True if the value is equal. False if not equal..</returns>
        public static bool HasLengthEqualTo(this string value, sbyte lenght) => value != null && value != null && value.Length == lenght;
        ...
        /// <param name="lenght">Desired length.</param>
        /// <returns>True if the value is equal. False if not equal..</returns>
        public static bool HasLengthEqualTo<T>(this IEnumerable<T> value, sbyte lenght) => value != null && value != null && value.Count() == lenght;
