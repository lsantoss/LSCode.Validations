namespace LSCode.Validations.BooleanValidations.Extensions
{
    ...
    public static class IsNotContactValidationExtension
    {
        /// <summary>Validates if the mobile number is invalid.</summary>
        /// <remarks>
        ///     Invalid formats: Mobile number with any format different than those mentioned below. <br></br>
        ...
        /// <returns>True if not a mobile number. False if it is.</returns>
        public static bool IsNotBrazilianCellphone(this string value) => !IsContactValidationExtension.IsBrazilianCellphone(value);

        /// <summary>Validates if the phone number is invalid.</summary>
        /// <remarks>
        ///     Valid formats: Phone number with any format different than those mentioned below. <br></br>
        ///     Position 0 and 1     : Brazilian DDI - 55 <br></br>
        ///     Position 2 and 3     : Valid Brazilian DDD - 11, 12, 13, 14, 15, 16, 17, 18, 19, 21, 22, 24, 27, 28, 31, 32, 33, 34, 35, 37, 38, 41, 42, 43, 44, 45, 46, 47, 48, 49, 51, 53, 54, 55, 61, 62, 63, 64, 65, 66, 67, 68, 69, 71, 73, 74, 75, 77, 79, 81, 82, 83, 84, 85, 86, 87, 88, 89, 91, 92, 93, 94, 95, 96, 97, 98, 99 <br></br>
        ...
        /// <returns>True if not a phone number. False if it is.</returns>
        public static bool IsNotBrazilianTelephone(this string value) => !IsContactValidationExtension.IsBrazilianTelephone(value);

        /// <summary>Validates if the email is invalid.</summary>
        /// <param name="value">Email that will be validated.</param>
        /// <returns>True if it is a email. False if not.</returns>
        public static bool IsNotEmail(this string value) => !IsContactValidationExtension.IsEmail(value);
    }
}